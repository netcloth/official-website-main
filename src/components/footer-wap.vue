  ...
  <div class="footer">
    <div class="footer-top">
      <div class="footer-logo">
        <img src="https://cdn.jsdelivr.net/gh/netcloth/official-website-main@v0.2.0/dist/images-wap/footer/footer-logo.png">
      </div>
    ...
    private GoRouter(val) {
      ...
      if( val =="paper"){
        if(localStorage.getItem("language") == "zh"){
          window.open('https://cdn.jsdelivr.net/gh/netcloth/official-website-main@v0.2.0/dist/docs/whitepaper_cn.pdf');
        }else{
...
<style lang="scss" scoped>
  ...
  .footer {
    ...
    .footer-medium {
      background: url('https://cdn.jsdelivr.net/gh/netcloth/official-website-main@v0.2.0/dist/images-wap/footer/medium.png');
      background-size: 100%;
    }

    .footer-twier {
      background: url('https://cdn.jsdelivr.net/gh/netcloth/official-website-main@v0.2.0/dist/images-wap/footer/twier.png');
      background-size: 100%;
    }

    .footer-github {
      background: url('https://cdn.jsdelivr.net/gh/netcloth/official-website-main@v0.2.0/dist/images-wap/footer/github.png');
      background-size: 100%;
    }

    .footer-wordpress {
      background: url('https://cdn.jsdelivr.net/gh/netcloth/official-website-main@v0.2.0/dist/images/footer/wordpress.png');
      background-size: 100%;
