    ...
    <div class="content clearfix">
      ...
      <div class="left clearfix">
        <div class="col1">
          ...
          <a class="row3" :href="GetLanguage()=='zh'?'https://cdn.jsdelivr.net/gh/netcloth/official-website-main@v0.1.9/dist/docs/whitepaper_cn.pdf':'https://github.com/netcloth/whitepaper/blob/master/whitepaper.md'" target="_blank">{{$t("footer_new.item13")}}</a>
...
.logo{
  width:166px;
  height:44px;
  background:url("https://cdn.jsdelivr.net/gh/netcloth/official-website-main@v0.1.9/dist/images/footer/logo.png");
...
.sublogo_1{
  @extend .sublogo;
  background:url("https://cdn.jsdelivr.net/gh/netcloth/official-website-main@v0.1.9/dist/images/footer/footer_sublogo_image1.png");
  background-size:100% 100%;
}
.sublogo_2{
  @extend .sublogo;
  background:url("https://cdn.jsdelivr.net/gh/netcloth/official-website-main@v0.1.9/dist/images/footer/footer_sublogo_image2.png");
  background-size:100% 100%;
  margin-left:24px;
}
.sublogo_3{
  @extend .sublogo;
  background:url("https://cdn.jsdelivr.net/gh/netcloth/official-website-main@v0.1.9/dist/images/footer/footer_sublogo_image3.png");
  background-size:100% 100%;
  margin-left:24px;
}
.sublogo_4{
  @extend .sublogo;
  background:url("https://cdn.jsdelivr.net/gh/netcloth/official-website-main@v0.1.9/dist/images/footer/footer_sublogo_image4.png");
  background-size:100% 100%;
  margin-left:24px;
}
.foot_right{
...
.codebar{
  width:128px;
  height:128px;
  background:url("https://cdn.jsdelivr.net/gh/netcloth/official-website-main@v0.1.9/dist/images/footer/community_cn.png");
  background-size:100% 100%;
}
.codebar_en{
  background:url("https://cdn.jsdelivr.net/gh/netcloth/official-website-main@v0.1.9/dist/images/footer/community_en.png");
  background-size:100% 100%;
}
</style>
