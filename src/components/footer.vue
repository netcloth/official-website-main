...
<style lang="scss" scoped>
  .footer {
    ...
    .footer-content-top-left {
      ...
      .footer-medium {
        background: url('/images/footer/medium.png');
      }

      .footer-medium:hover {
        cursor: pointer;
        background: url('/images/footer/medium-hover.png');
      }

      .footer-twier {
        background: url('/images/footer/twier.png');
      }

      .footer-twier:hover {
        cursor: pointer;
        background: url('/images/footer/twier-hover.png');
      }

      .footer-github {
        background: url('/images/footer/github.png');
      }

      .footer-github:hover {
        cursor: pointer;
        background: url('/images/footer/github-hover.png');
      }
      ...
      .footer-wordpress:hover {
        cursor: pointer;
        background: url('/images/footer/wordpress-hover.png');
        background-size: 100%;
      }
