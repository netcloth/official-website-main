...
<template>
  <div class="homeHeader">
    ...
    <img src="https://cdn.jsdelivr.net/gh/netcloth/official-website-main@v0.2.0/dist/images-wap/home/Moon.png" class="homeHeader-img">
  ...
  export default class HomeHeader extends Vue {
    ...
    private GoUrl(url){
      if(url=="paper"){
        ...
        if(localStorage.getItem("language") == "zh"){
          window.open("https://cdn.jsdelivr.net/gh/netcloth/official-website-main@v0.2.0/dist/docs/EcologicalConstruction_cn.pdf");
        }else{
...
<style lang="scss" scoped>
  ...
  .homeHeader {
    ...
    .homeHeader-logo {
      width: px2rem(133);
      height: px2rem(100);
      background-image: url('https://cdn.jsdelivr.net/gh/netcloth/official-website-main@v0.2.0/dist/images-wap/home/logo.png');
