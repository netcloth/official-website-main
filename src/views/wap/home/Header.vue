...
<template>
  <div class="homeHeader">
    ...
    <img src="https://cdn.jsdelivr.net/gh/netcloth/official-website-main@v0.1.6/dist/images-wap/home/Moon.png" class="homeHeader-img">
...
<style lang="scss" scoped>
  ...
  .homeHeader {
    ...
    .homeHeader-logo {
      width: px2rem(133);
      height: px2rem(100);
      background-image: url('https://cdn.jsdelivr.net/gh/netcloth/official-website-main@v0.1.6/dist/images-wap/home/logo.png');
