...
<template>
  <div class="homeHeader">
    ...
    <img src="https://cdn.jsdelivr.net/gh/netcloth/official-website-main@v0.0.2/dist/images/home/Moon.png" class="homeHeader-img">
...
export default class HomeHeader extends Vue {
  ...
  private EachList() {
    ...
    const w = can.width = window.innerWidth < 1100 ? 1100 : window.innerWidth;
...
<style lang="scss" scoped>
  .homeHeader {
    ...
    .homeHeader-logo {
      width: 7vw;
      height: 134px;
      background-image: url('https://cdn.jsdelivr.net/gh/netcloth/official-website-main@v0.0.2/dist/images/home/logo.png');
      background-size: 100%;
