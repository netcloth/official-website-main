...
.item_image1{
  @extend .item_image;
  background:url("https://cdn.jsdelivr.net/gh/netcloth/official-website-main@v0.1.1/dist/images/starfish/resource_image1.png");
  background-size:100% 100%;
  cursor: pointer;
}
.item_image2{
  @extend .item_image;
  background:url("https://cdn.jsdelivr.net/gh/netcloth/official-website-main@v0.1.1/dist/images/starfish/resource_image2.png");
  background-size:100% 100%;
  cursor: pointer;
}
.item_image3{
