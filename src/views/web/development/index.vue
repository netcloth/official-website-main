 ...
 * @Author: 黄龙
 * @LastEditors: 黄龙
 * @LastEditTime: 2019-10-08 14:15:16
 -->
<template>
  <div class="development">
    <Header imgSrc='https://cdn.jsdelivr.net/gh/netcloth/official-website-main@v0.2.4/dist/images/development/logo-red.png' Pcolor='#17213C' />
    <devHome />
    <div class="footer">
      <Footer />
    </div>
